...
%	what is planning
	...
	% Danglish: Can come ville man ikke sige.
	% "with a subset of the problems types" der er noget ejefald der er forkert. Tror der skal stå "with a subset of the problem's types"? Et subset af problemETS typer?
	...
	% Nej. Bare nej. "In under"? Danglish. Categorized as er bedre.
...
%	what is a planner
	% "automate process" -- nope. Automating proccesses?
	% Du bruger building either to use. Vær konsekvent. "To use a planner for the particular", og "to use a general", f.eks.
	...
	% Volapyk. Omformuler. Hvor kommer planning language ind i billedet?!
	...
	% Consist of way of describing osv., huh?! 
	Such a language consists of a way of describing initial state, goal state and the possible actions available to manipulate the current state. The most common way of describing this is using the planning language PDDL. 
...
%	in reality things/actions dont always behave like this, they happen over a time span.... effect under and after, preconditions holds....
	...
	% "Many obstacles on the part", mener du path?!
	...
	% Where learning comes into the picture? Nej. Tror du skal omformuler så det er en introduktion til hvad learning er. F.eks.
	% In order to mitigate this, the concept of learning is introduced. By allowing the planner to learn from previously solved problems, it becomes more self-sufficient.
	...
	%Astro kid // purpose'
	%Første sætning skal omformuleres
	...
	% burde World ikke være med lille w?
	% Meget lang sætning. Bryd op i to.
