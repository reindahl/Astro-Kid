...
The solution for the grounding have a huge impact on the relaxation since it removes a lot of non useful predicates which means the chance of the relaxation effecting the right predicate increases.
...
%	simpliefie by only allowing destintingt effects?
	...
	When looking at conditionals and disjunction they both have the property that they can be compiled away by splitting the action into multiple actions. %This can be done due each action having a finite set of outcomes
